...
module.exports = {
  activate: function() {
    ...
    regard.setDefaultProperties({'atom.version': atom.getVersion(), "env.os" : window.navigator.platform, "env.language" : window.navigator.language});
  ...
  showMyData: function() {
    shell.openExternal(regard.getUserDataUrl());
  },
  begin: function(){
